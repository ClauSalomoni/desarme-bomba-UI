...
const dicasFio = gerarDicasFio(ordemGerada);
    function cortarFioVerde(texto) {
      ...
      imgFioVerde.src = 'assets/imagens/verde.png'
      fioCortado = 0
    ...
    function cortarFioRoxo(texto) {
      ...
      imgFioRoxo.src = 'assets/imagens/roxo.png'
      fioCortado = 1
    ...
    function cortarFioAmarelo(texto) {
      ...
      imgFioAmarelo.src = 'assets/imagens/amarelo.png'
      fioCortado = 2
    ...
    function cortarFioLaranja(texto) {
      ...
      imgFioLaranja.src = 'assets/imagens/laranja.png'
      fioCortado = 3
    ...
    function cortarFioCiano(texto) {
      ...
      imgFioCiano.src = 'assets/imagens/ciano.png'
      fioCortado = 4
